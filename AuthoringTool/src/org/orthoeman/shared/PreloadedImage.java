 ...
 *
 *         <p>
 *         An Image widget that preloads the picture, and in the case of success
 *         executes a user action. It stores the original width and height of
 *         the image that can be used for calculations.
 *         </p>
 */
public class PreloadedImage extends Image {
	 ...
	 * @param onLoad handler to be executed in the case of success loading
	 */
	 ...
	 *
	 * @param url    The image url
	 * @param uniqId A unique id that identifies this image
	...
	/**
	 * Get the real size of the image. It is calculated when the image loads
	 *
	 */
